...
let CATEGORIES = ['Bubble Tea', 'Sweets', 'Snacks', 'Gift Sets', 'Christmas Festive', 'Housebake Cookies', 'National Day Snacks', 'Deepavali', 'Hari Raya'];

/* Order categories appear in the filter bar (Christmas Festive featured first). */
let CATEGORY_BAR_ORDER = ['Christmas Festive', 'Bubble Tea', 'Sweets', 'Snacks', 'Gift Sets', 'Housebake Cookies', 'National Day Snacks', 'Deepavali', 'Hari Raya'];
