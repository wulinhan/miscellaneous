...
let PRODUCTS = [
  ...
  {"id": "kueh-bangkit", "title": "Kueh Bangkit", "tags": ["Retro Snacks"], "emoji": "🍘", "color": "#d7a24a", "shortDesc": "Melt-in-the-mouth coconut tapioca cookies, a festive favourite.", "longDesc": "Ingredients: Tapioca Flour, Wheat Flour, Sugar, Coconut Milk, Magarine, Egg, Vegetable Oil, Custard Powder, Salt.", "price": 1.8, "unit": "pack", "sizes": [{"label": "Petite Pack (30g)", "price": 1.8}, {"label": "Nostalgic Tin (350g)", "price": 11.8}], "upsell": [], "alsoBought": ["iced-gems", "potato-wheels", "pandan-waffle"], "allergens": ["Dairy", "Gluten", "Nuts", "Eggs"]},
  ...
  {"id": "prawn-roll", "title": "Prawn Roll", "tags": ["Retro Snacks"], "emoji": "🍘", "color": "#d7a24a", "shortDesc": "Crispy rolls with a savoury dried-shrimp filling.", "longDesc": "Ingredients: Flour, Dried Shrimp, Vegetable Oil, Sugar, Chili Powder, MSG, Potassium Sobate.", "price": 1.8, "unit": "pack", "sizes": [{"label": "Petite Pack (50g)", "price": 1.8}, {"label": "Regular Pack (150g)", "price": 5.0}, {"label": "Bottle (150g)", "price": 6.8}], "upsell": [], "alsoBought": ["iced-gems", "potato-wheels", "pandan-waffle"], "allergens": ["Gluten"]},
  {"id": "curry-tapioca-chips", "title": "Curry Tapioca Chips", "tags": ["Retro Snacks", "Deepavali"], "emoji": "🍘", "color": "#d7a24a", "shortDesc": "Crunchy tapioca chips tossed in fragrant curry spice.", "longDesc": "Ingredients: Fresh Tapioca, Salt, Palm Oil, Curry Powder.", "price": 5.0, "unit": "pack", "sizes": [{"label": "Regular Pack (50g)", "price": 5.0}, {"label": "Bottle (70g)", "price": 6.8}], "upsell": [], "alsoBought": ["iced-gems", "potato-wheels", "pandan-waffle"], "allergens": []},
  ...
  {"id": "ladoo-tart", "title": "Ladoo Tart", "tags": ["Deepavali"], "emoji": "🪔", "color": "#c4683a", "shortDesc": "Melt-in-the-mouth ghee tarts scented with cardamom.", "longDesc": "Ingredients: Unsalted Butter, cardamom powder, Ghee, Sugar, Water, Salt.", "price": 9.8, "unit": "pack", "sizes": [{"label": "Bottle (8 pcs)", "price": 9.8}], "upsell": [], "alsoBought": ["ribbon-murukku", "classic-murukku", "puff-rice-indian-mixer"], "allergens": ["Dairy"]},
  ...
  {"id": "kueh-makmur", "title": "Kueh Makmur", "tags": ["Hari Raya"], "emoji": "🌙", "color": "#4e8f7a", "shortDesc": "Snowy, melt-in-the-mouth cookies with buttery peanut.", "longDesc": "Ingredients: Wheat Flour, Butter, Sugar, Peanut, Ghee, Palm Oil, Baking Powder.", "price": 9.8, "unit": "pack", "sizes": [{"label": "Bottle (16 pcs)", "price": 9.8}], "upsell": [], "alsoBought": ["kerepek-singkong", "kerepek-stick", "rempeyek"], "allergens": ["Dairy", "Gluten", "Nuts"]},
  ...
  {"id": "crab-stick", "title": "Crab Stick", "tags": ["Hari Raya"], "emoji": "🌙", "color": "#4e8f7a", "shortDesc": "Crispy crabstick snacks, light and savoury.", "longDesc": "Ingredients: Crabstick, Palm Oil.", "price": 9.8, "unit": "pack", "sizes": [{"label": "Bottle (200g)", "price": 9.8}], "upsell": [], "alsoBought": ["kueh-makmur", "kerepek-singkong", "kerepek-stick"], "allergens": []},
